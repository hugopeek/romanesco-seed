...
You can also install Gitify separately with each new project. This is done automatically if no global Gitify was found, so make sure the `gitifyCmd` variable is empty or disabled in config.sh.
